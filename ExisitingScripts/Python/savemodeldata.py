...
for e in range(18):
   for t in range(96):   
      ...
      ranges,z,azi_final,rad_final=cylindrical_azirad(ucube,vcube,lonn[int(TIMETOLOAD)],latt[int(TIMETOLOAD)])
      np.save("cyl_azi_e{0}_t{1}.npy".format(e,t),azi_final)
      np.save("cyl_rad_e{0}_t{1}.npy".format(e,t),rad_final)
