...
def plot_data(strain,avg_strain,outfile,pos_id,plev,dtick=5):
    ...
    fig.suptitle('Deformation anomaly, {0:03d}hPa'.format(plev))
        ...
        for TT in times:
            ...
            for dd in vt_day:
                for hr in vt_hr:
                    ...
                    for plev in plevs:
                        strain = []
                        outfile = '/nfs/a37/scjea/model_runs/Hagupit/u-ap087/plots/glm/{0:04d}_{1:02d}Z/ensemble_plots/deformanom_{2:02d}_{3:02d}Z_{4:03d}hPa.png'.format(md,TT,dd,hr,plev)
                        ...
                        for u,v in zip(u_list,v_list):
                            stretching = calc_stretching(u,v)
                            shearing = calc_shearing(u,v)
                            deformation = (stretching**2 + shearing**2)**0.5
                            strain.append(deformation)
